       ...
       <v-layout row>
        <v-flex xs12 >
          <v-card class="cardContainer">
            ...
            <div>
              <div class="headline">Situation Title</div>
              <h2 class="usernameSituation">username</h2>
             ...
             <v-card-actions class="links">
              ...
              <v-btn class="viewSolution" icon @click="show = !show">
                <span>{{ show ? 'Close' : 'See *usernames* Solution' }}</span>
              </v-btn>
              </div>
            </v-card-actions>
            ...
            <div>
              ...
              This is where the solution to the situation will populate.
              <v-slider class="slider" v-model="value" step="1" thumb-label></v-slider>
            </v-card-text>
            </div>
            </v-slide-y-transition>
          </v-card>
